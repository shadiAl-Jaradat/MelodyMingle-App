...
class AudioPlayerController extends GetxController {
  ...
  RxList<Artist> listOfArtist = <Artist>[].obs;
  RxList<Song> searchedSongs = <Song>[].obs;
  RxList<Song> podcasts = <Song>[].obs;
  ...
  void setListOfArtist(List<Artist> artists) {
    listOfArtist = artists.obs;
  }
  ...
  void setPodcasts(List<Song> songs) {
    podcasts.value = songs;
  }
